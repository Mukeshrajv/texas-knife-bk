...
const SubList = ({navigation}) => {
   ...
   const encodedsubcategoryid = encodeURIComponent(useSelector((state)=>state.category.categoryid));
  ...
  useEffect(()=>{
      ...
      const subcategorylistapi='https://www.texasknife.com/dynamic/texasknifeapi.php?action=cus_sub_category&category_id='+encodedsubcategoryid;
